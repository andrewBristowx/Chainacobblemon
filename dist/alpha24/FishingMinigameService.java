...
public final class FishingMinigameService {
    ...
    private static void onPokemonSpawned(BobberSpawnPokemonEvent.Post event) {
        try {
            ...
            // The exact Pokémon object survives entity discard. This prevents it walking away, battling or
            ...
            Session session = new Session(UUID.randomUUID(), player.getUuid(), pokemon, speciesId, speciesName,
    ...
    private static final class Session {
        ...
        Session(UUID id, UUID playerId, Pokemon pokemon, String speciesId, String speciesName,
